...
//                 </h2>
//                 <p className="text-sm text-luxury-muted">
//                   This area will become your charts + branch breakdown.
//                 </p>
//               </div>

//               <div className="p-6">
//                 <div className="h-[240px] rounded-xl border border-white/10 bg-black/20 flex items-center justify-center text-sm text-luxury-muted">
//                   Charts placeholder
//                 </div>
//               </div>
//             </div>
...
//                 </h2>
//                 <p className="text-sm text-luxury-muted">
//                   Later: who deleted/restored what.
//                 </p>
//               </div>

//               <div className="p-6">
//                 <div className="flex flex-col gap-3 text-sm text-luxury-muted">
//                   <div className="flex items-center justify-between border-b border-white/5 pb-3">
//                     <span>Vehicle updated</span>
//                     <span className="text-xs text-luxury-muted/70">—</span>
//                   </div>
//                   <div className="flex items-center justify-between border-b border-white/5 pb-3">
...
//         <span className={`text-sm font-medium ${danger ? "text-red-300" : "text-luxury-text"}`}>
//           {title}
//         </span>

...
//       {/* TABLE */}
//       <div className="overflow-x-auto">
//         {/* ✅ CHANGE: added min-w-[980px] so iPad has breathing room and actions don't feel cramped */}
...
//               <tr key={car._id} className="hover:bg-white/5 transition">
//                 {/* VEHICLE */}
//                 {/* ✅ CHANGE: px-4 -> px-6 to match other columns (uniform alignment) */}
//                 <td className="px-6 py-4">
//                   <div className="flex items-center gap-4">
//                     {/* Thumbnail */}
//                     <div className="relative h-14 w-14 rounded-lg overflow-hidden border border-white/10 bg-black/20 shrink-0">
...
//                 {/* ACTIONS */}
//                 {/* ✅ CHANGE: added pr-8 so right side has more breathing room (matches the thumbnail feel) */}
//                 <td className="px-6 pr-8 py-4">
//                   {mode === "trash" ? (
//                     // ✅ TRASH MODE: ONLY Restore + Delete Forever
//                     // ✅ CHANGE: added gap-x and gap-y so wrap spacing is nicer on tablet
